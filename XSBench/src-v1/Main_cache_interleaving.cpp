...
// CL binary name
const char *binary_prefix = "Simulation_pipe_pointer_float_accu_cache_noauto_interleaving_350_high_effort_one_channel_v2";
//const char *binary_prefix = "Simulation";
		...
		unsigned long *vhash)
{
	...
	status = clEnqueueTask(queues[K_CAL_VHASH], kernels[K_CAL_VHASH], 0, NULL, NULL);
