...
const char *binary_prefix = "Simulation_10bsc_nochannel_depth_nop"; //_noprofile";
...
int main( int argc, char* argv[] )
{
	...
	*/
	...
	printf("vec size: %d\n", vec_size);
	int *energy_grid_xs = (int *) alignedMalloc(n_iso_grid * vec_size * sizeof(int));	
	num_points = 0;
